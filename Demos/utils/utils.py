...
def computer_vision(odo_dist, K, dist, cap, orb, bf, prev_gray, kp_prev, des_prev):
    ret, raw = cap.read()
    if not ret:
        return "break", _, _
    ...
    if des is None or des_prev is None or len(des_prev) < 8:
        ...
        return "continue", prev_gray, kp_prev, des, dists
    ...
    if E is None:
        ...
        if cv.waitKey(1)&0xFF==27: return "break", prev_gray, kp_prev, des, dists
        return "continue", prev_gray, kp_prev, des, dists
    ...
    return "normal", prev_gray, kp_prev, des, dists, raw